    ...
    <div class="row">
      <div class="col s12 m8 l6 offset-m2 offset-l3">
        <div class="card hoverable">
          <div class="card-content red darken-4 white-text center-align">
            <h4><i class="material-icons">error</i> ¡Error al iniciar sesión!</h4>
            <p>Por favor, ingresa los datos correctamente.</p>
          </div>
            ...
            <form method="POST" action="logica/loguear.php">
              ...
              <div class="center-align">
                <button class="btn waves-effect waves-light red darken-4" type="submit" name="action">
                  Reintentar <i class="material-icons right">refresh</i>
                </button>
              </div>
            </form>
          </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col l3 s12">
          ...
          <ul>
            <li><a class="amber-text text-lighten-3" href="https://www.youtube.com/@jmv_Isaac">YouTbues</a></li>
